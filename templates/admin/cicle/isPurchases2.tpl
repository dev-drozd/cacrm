...
<!-- 	<div class="td noWrap">
	...
	<div class="td">
		<span class="thShort">Price: </span>{currency} <span class="servPrice" ondblclick="issues.pPrice(this, {id}, {issue-id}, 'purchase_info')" data-price="{price}" data-cost-price="{cost-price}">{price}</span>
	</div>
	<div class="td">Purchase</div>
	<div class="td w10">
