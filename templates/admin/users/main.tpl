...
<section class="mngContent">
	...
	<div class="mngSearch">
		<input type="text" name="search" onkeydown="Rec.on(event, Search);" placeholder="&#xf002; Start typing or press F2 to say" onkeypress="if(event.keyCode == 13) Search(this.value);" oninput="checkBarcode(this.value);" class="fa">
