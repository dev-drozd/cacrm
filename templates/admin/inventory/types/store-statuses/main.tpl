...
<section class="mngContent">
	<div class="sTitle"><span class="fa fa-chevron-right"></span>{lang=allStatuses} <a href="#" class="btn addBtn" onclick="inventory.openStoreStatus(); return false;">{lang=addStatus}</a></div>
	<div class="mngSearch">
