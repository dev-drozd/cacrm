<div class="pnl fw lPnl">
	...
	<div class="mngSearch">
		<input type="text" name="searchText" placeholder="Task search" onkeypress="if(event.keyCode == 13) Search(this.value);">
...
<script>
	$(function() {
		...
		$.post('/users/all', {staff: 1, nIds: Object.keys($('input[name="create"]').data()).join(',')}, function (r) {
			if (r){
				var items = '', lId = 0;
				$.each(r.list, function(i, v) {
					items += '<li data-value="' + v.id + '">' + v.name + '</li>';
