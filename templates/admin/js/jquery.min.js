...
!function(){"use strict";function e(e){return e.charAt(0).toUpperCase()+e.slice(1)}if("webkitSpeechRecognition"in window){var t=document.getElementsByClassName("speech-input");[].forEach.call(t,function(t){function n(){h=setTimeout(function(){b.stop()},1e3*o)}var a,s,i,l,o=parseInt(t.dataset.patience,10)||6,r=t.nextSibling,c=t.parentNode,d=parseInt(getComputedStyle(t).borderRightWidth,10),u=.8*(t.dataset.buttonsize||t.offsetHeight);!t.dataset.buttonsize&&"TEXTAREA"===t.tagName&&u>26&&(u=26);var p=t.parentNode;p.classList.contains("si-wrapper")||((p=document.createElement("div")).classList.add("si-wrapper"),p.appendChild(c.removeChild(t)),l=!0),(a=p.querySelector(".si-btn"))||((a=document.createElement("button")).type="button",a.classList.add("si-btn"),a.textContent="speech input",s=document.createElement("span"),i=document.createElement("span"),s.classList.add("si-mic"),i.classList.add("si-holder"),a.appendChild(s),a.appendChild(i),p.appendChild(a),a.style.cursor="pointer",a.style.top=.125*u+"px",a.style.height=a.style.width=u+"px",t.style.paddingRight=u-d+"px"),l&&c.insertBefore(p,r);var m,h,f="",v=!1,g=null,b=new webkitSpeechRecognition;b.continuous=!0,b.interimResults=!0,t.lang&&(b.lang=t.lang),b.onstart=function(){g=t.placeholder,t.placeholder=t.dataset.ready||"Speak now",v=!0,a.classList.add("listening"),n()},b.onend=function(){v=!1,clearTimeout(h),a.classList.remove("listening"),null!==g&&(t.placeholder=g),void 0!==t.dataset.instantSubmit&&t.value&&t.form&&t.form.submit()},b.onresult=function(a){clearTimeout(h);for(var s=a.results,i="",l="",o=a.resultIndex;o<s.length;++o){var r=s[o],c=r[0];r.isFinal?i=c.transcript:l+=c.transcript}var d=i||l;d=!f||m?e(d):d,t.value=f+d,t.focus(),"INPUT"===t.tagName?t.scrollLeft=t.scrollWidth:t.scrollTop=t.scrollHeight,n()},a.addEventListener("click",function(e){if(e.preventDefault(),v)b.stop();else{var n=t.value.slice(-1).match(/\s/);f=!t.value||n?t.value:t.value+" ",m=f.trim().slice(-1).match(/[\.\?\!]/),b.start()}},!1)})}}();
