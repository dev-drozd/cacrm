...
<section class="mngContent">
	<div class="sTitle">
		<span class="fa fa-chevron-right"></span>{lang=allPages}
		<div class="filters">
		...
		[add-page]<a href="/store/pages/add" class="btn addBtn" onclick="Page.get(this.href); return false;">{lang=addPage}</a>[/add-page]
	</div>
	<div class="mngSearch">
		<input type="text" name="search" placeholder="{lang=PagesSearch}" onkeypress="if(event.keyCode == 13) Search2(this.value);">
