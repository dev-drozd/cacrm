...
<section class="mngContent">
	...
	<form class="uForm" method="post">
		...
		<div class="sGroup">
			<button class="btn btnSubmit" type="button" onclick="analytics.expansesReport(this);"><span class="fa fa-save"></span> {lang=GetReport}</button>
		</div>
	</form>
	<div id="report">
	</div>
...
<script>
	$(function() {
		...
		analytics.expansesReport(document.getElementsByTagName('button')[0], 1);
