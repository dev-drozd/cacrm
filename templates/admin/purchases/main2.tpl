...
<section class="mngContent">
	...
	<div class="mngSearch">
		<input type="text" name="search" placeholder="Purchase search" onkeypress="if(event.keyCode == 13) Search(this.value);" oninput="checkBarcode(this.value);">
	...
	<table class="responsive">
		<thead>
			<tr>
				...
				<!-- <th><a data-sort="transaction" data-sort-type="0" href="#" onclick="return sortRes(this);">TRANSACTION</a></th> -->
				<th><a data-sort="status" data-sort-type="0" href="#" onclick="return sortRes(this);">STATUS</a></th>
				<!-- <th><a data-sort="tracking" data-sort-type="0" href="#" onclick="return sortRes(this);">TRACKING</a></th> -->
				<!-- <th><a data-sort="estimated" data-sort-type="0" href="#" onclick="return sortRes(this);">ESTIMATED</a></th> -->
