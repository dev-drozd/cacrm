...
<div class="mngContent">
	<div class="pnlTitle">
		...
		<span class="hnt hntTop exportXls" data-title="Points payout history" onclick="Page.get('/salary/points/history')"><span class="fa fa-book"></span></span>
		...
		<span class="hnt hntTop exportXls mR0" data-title="Salary analytics" onclick="Page.get('/salary/points/analytics')"><span class="fa fa-line-chart"></span></span>
	...
	<div class="tbl">
		<div class="tHead">
			<div class="tr">
				...
				<div class="th w125">All Points</div>
				<div class="th w125">New Points</div>
				<div class="th w275">Make payout</div>
			</div>
		</div>
	</div>
