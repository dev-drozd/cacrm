...
<div class="mngContent">
	<div class="pnlTitle">
		...
		<!--<span class="hnt hntTop exportXls" data-title="Salary history" onclick="Page.get('/salary/history')"><span class="fa fa-book"></span></span>-->
		<span class="hnt hntTop exportXls" data-title="Download XLS report" id="download"><span class="fa fa-download"></span></span>
	</div>
	<div class="mngSearch">
		<input type="text" name="searchText" placeholder="{lang=staffSearch}" onkeypress="if(event.keyCode == 13) Search2(this.value);">
	...
	<div class="tbl">
		<div class="tHead">
			<div class="tr">
				...
				<div class="th w125">Salary</div>
				<div class="th w125">On site Salary</div>
				<div class="th w125">Total</div>
			</div>
		</div>
	</div>
