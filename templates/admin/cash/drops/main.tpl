...
<section class="mngContent ffullw">
	<div class="sTitle">
			...
			<div class="filterCtnr">
				...
				<div class="iGroup fw">
					...
					<select name="status">
						...
						<option value="unconfirmed">{lang=NotConfirmed}</option>
					</select>
				</div>
		...
		<span class="hnt hntTop exportXls" data-title="{lang=DropsConfirmHistory}" onclick="Page.get('/cash/drops/history')"><span class="fa fa-book"></span></span>
	</div>
	<div class="mngSearch">
