...
abstract class BaseSerializationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDateTimeArrays()
    {
        $data = array(
            ...
            new \DateTime('2020-12-05 00:00:00', new \DateTimeZone('UTC'))
        );
    ...
    public function testNamedDateTimeImmutableArrays()
    {
        $data = array(
            ...
            new \DateTimeImmutable('2020-12-05 00:00:00', new \DateTimeZone('UTC'))
        );
    ...
    {
        $value = new Timestamp(new \DateTime('2020-02-11 00:00:00', new \DateTimeZone('UTC')));
